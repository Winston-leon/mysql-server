...
#ifdef HAVE_LIBNUMA
char* sched_affinity_args[sched_affinity::TT_MAX];
...
static Sys_var_charptr Sys_sched_affinity_foreground_thread(
    ...
    READ_ONLY GLOBAL_VAR(sched_affinity_args[sched_affinity::TT_FOREGROUND]), CMD_LINE(REQUIRED_ARG),
...
static Sys_var_charptr Sys_sched_affinity_log_writer(
    ...
    READ_ONLY GLOBAL_VAR(sched_affinity_args[sched_affinity::TT_LOG_WRITER]), CMD_LINE(REQUIRED_ARG),
    IN_FS_CHARSET, DEFAULT(nullptr));
...
static Sys_var_charptr Sys_sched_affinity_log_flusher(
    ...
    READ_ONLY GLOBAL_VAR(sched_affinity_args[sched_affinity::TT_LOG_FLUSHER]), CMD_LINE(REQUIRED_ARG),
    IN_FS_CHARSET, DEFAULT(nullptr));
...
static Sys_var_charptr Sys_sched_affinity_log_write_notifier(
    ...
    READ_ONLY GLOBAL_VAR(sched_affinity_args[sched_affinity::TT_LOG_WRITE_NOTIFIER]), CMD_LINE(REQUIRED_ARG),
    IN_FS_CHARSET,  DEFAULT(nullptr));
...
static Sys_var_charptr Sys_sched_affinity_log_flush_notifier(
    ...
    READ_ONLY GLOBAL_VAR(sched_affinity_args[sched_affinity::TT_LOG_FLUSH_NOTIFIER]), CMD_LINE(REQUIRED_ARG),
    IN_FS_CHARSET, DEFAULT(nullptr));
...
static Sys_var_charptr Sys_sched_affinity_log_closer(
    ...
    READ_ONLY GLOBAL_VAR(sched_affinity_args[sched_affinity::TT_LOG_CLOSER]), CMD_LINE(REQUIRED_ARG),
    IN_FS_CHARSET, DEFAULT(nullptr));
...
static Sys_var_charptr Sys_sched_affinity_log_checkpointer(
    ...
    READ_ONLY GLOBAL_VAR(sched_affinity_args[sched_affinity::TT_LOG_CHECKPOINTER]), CMD_LINE(REQUIRED_ARG),
    IN_FS_CHARSET, DEFAULT(nullptr));
...
static Sys_var_charptr Sys_sched_affinity_purge_coordinator(
    ...
    READ_ONLY GLOBAL_VAR(sched_affinity_args[sched_affinity::TT_PURGE_COORDINATOR]), CMD_LINE(REQUIRED_ARG),
    IN_FS_CHARSET,  DEFAULT(nullptr));
#endif
