...
void log_writer(log_t *log_ptr) {
  ...
  if (sched_affinity_manager!=nullptr){
    if(!sched_affinity_manager->bind_to_target(sched_affinity::Thread_type::LOG_WRITER, my_thread_self())){
...
void log_flusher(log_t *log_ptr) {
  auto sched_affinity_manager = sched_affinity::Sched_affinity_manager::get_instance();
  if (sched_affinity_manager!=nullptr){
    if(!sched_affinity_manager->bind_to_target(sched_affinity::Thread_type::LOG_FLUSHER, my_thread_self())){
...
void log_write_notifier(log_t *log_ptr) {
  auto sched_affinity_manager = sched_affinity::Sched_affinity_manager::get_instance();
  if (sched_affinity_manager!=nullptr){
    if(!sched_affinity_manager->bind_to_target(sched_affinity::Thread_type::LOG_WRITE_NOTIFIER, my_thread_self())){
...
void log_flush_notifier(log_t *log_ptr) {
  auto sched_affinity_manager = sched_affinity::Sched_affinity_manager::get_instance();
  if (sched_affinity_manager!=nullptr){
    if(!sched_affinity_manager->bind_to_target(sched_affinity::Thread_type::LOG_FLUSH_NOTIFIER, my_thread_self())){
...
void log_closer(log_t *log_ptr) {
  auto sched_affinity_manager = sched_affinity::Sched_affinity_manager::get_instance();
  if (sched_affinity_manager!=nullptr){
    if(!sched_affinity_manager->bind_to_target(sched_affinity::Thread_type::LOG_CLOSER, my_thread_self())){
